...
export type InitializeInstruction<
  TProgram extends string = typeof SOLANA_STARTER_PROGRAM_ADDRESS,
...
export function getInitializeInstruction<
  TProgramAddress extends Address = typeof SOLANA_STARTER_PROGRAM_ADDRESS,
>(config?: { programAddress?: TProgramAddress }): InitializeInstruction<TProgramAddress> {
  // Program address.
  const programAddress = config?.programAddress ?? SOLANA_STARTER_PROGRAM_ADDRESS
...
export type ParsedInitializeInstruction<TProgram extends string = typeof SOLANA_STARTER_PROGRAM_ADDRESS> = {
